...
{
    public class EndGameScreen : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            tituloTexture = Game.Content.Load<Texture2D>("handIcon"); // <= cambiar aqui imagen de fin de juego
        ...
        {
            botones[0] = new Button((this.Game.GraphicsDevice.Viewport.Width / 2 - 350), 380, botonSalirTxt2d, 300, 100, Game);
        ...
        private void HomeScreen_presionadoEventArgs(object sender, ButtonEventArgs e)
        {
            if (e.estadoActual == EstadoBoton.Seleccionado)
            {
                ...
                salirScreenEventArgs(sender, new ScreenEventArgs(TipoScreen.Pausa));
                //  ocultar();
            }
        }
