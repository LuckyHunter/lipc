...
namespace ArmaPalabra.Screens
{
    public class PauseScreen : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            botonContinuarTxt2d = Game.Content.Load<Texture2D>("botonContinuar");
        ...
        {
            botones[0] = new Button((this.Game.GraphicsDevice.Viewport.Width / 2 - 350), 380, botonContinuarTxt2d, 300, 100, Game);
